...
# once it gets to the integer object 3 the if clause will evaluate to true and the loop iteration will stop, since return keyword is used and is not passed an expression it will return 'nil'
